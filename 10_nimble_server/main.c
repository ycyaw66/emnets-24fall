...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    {
        ...
        .uuid = BLE_UUID16_DECLARE(0x1819),
...
{
    struct os_mbuf *om;
    om = ble_hs_mbuf_from_flat(&send_data, sizeof(send_data));
    ble_gattc_notify_custom(_conn_handle, _hrs_val_handle, om);
}
...
int main(void)
{
    ...
    nimble_autoadv_cfg_t cfg = {
        ...
        .adv_itvl_ms = BLE_GAP_ADV_ITVL_MS(ADV_INTERVAL),
